...
- [Deny user release requests](#approve-or-deny-release-requests-from-users-for-quarantined-email) if the **Release status** value of the messages is **Released requested**.

- [Delete email messages from quarantine](#delete-email-from-quarantine)
