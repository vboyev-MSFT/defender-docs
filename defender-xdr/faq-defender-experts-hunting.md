...
|**Does Defender Experts for Hunting either use or need Microsoft Sentinel or a SIEM?**| No. Defender Experts does not use any third-party data ingested via either Microsoft Sentinel or any other SIEM.|
