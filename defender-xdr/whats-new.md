...
- (Preview) SOC optimizations now include [new recommendations](/azure/sentinel/soc-optimization/soc-optimization-reference) for adding data sources to your workspace based on the security posture of other organizations in similar industries and sectors as you, and with similar data ingestion patterns.
