...
- (Preview) The [Link to incident](advanced-hunting-defender-results.md#link-query-results-to-an-incident) feature in Microsoft Defender advanced hunting is now available for preview and can be used to link Defender XDR and Microsoft Sentinel query results into an incident. In both the Microsoft Defender unified experience and in [Defender XDR advanced hunting](advanced-hunting-link-to-incident.md), you can now specify whether a related entity is an impacted asset or related evidence.
