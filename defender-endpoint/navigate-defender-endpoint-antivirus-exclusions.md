...
|[Defender for Endpoint Domain/URL and IP address Indicators](#defender-for-endpoint-indicators) |SmartScreen, WebContent Filtering, Network Protection |SmartScreen false positive (FP) or to override a Web Content Filtering (WFC) block on a specific site.|
