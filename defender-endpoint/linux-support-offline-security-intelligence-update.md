...
- Use the following sample `mdatp_managed.json`, update the parameters as per the configuration, and copy the file to the location `/etc/opt/microsoft/mdatp/managed/mdatp_managed.json`.
